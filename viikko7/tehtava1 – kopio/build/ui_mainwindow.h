...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(398, 252);
        centralwidget = new QWidget(MainWindow);
        centralwidget->setObjectName("centralwidget");
        gridLayoutWidget = new QWidget(centralwidget);
        gridLayoutWidget->setObjectName("gridLayoutWidget");
        gridLayoutWidget->setGeometry(QRect(70, 50, 241, 102));
        gridLayout = new QGridLayout(gridLayoutWidget);
        gridLayout->setObjectName("gridLayout");
        gridLayout->setContentsMargins(0, 0, 0, 0);
        count = new QPushButton(gridLayoutWidget);
        count->setObjectName("count");

        gridLayout->addWidget(count, 1, 0, 1, 1);

        teksti = new QLineEdit(gridLayoutWidget);
        teksti->setObjectName("teksti");

        gridLayout->addWidget(teksti, 0, 0, 1, 1);
